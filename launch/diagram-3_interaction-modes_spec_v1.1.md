# Diagram 3 Spec — "Interaction modes: drift / swirl / push / attract / return" (v1.1)

v1.1 (2026-05-29): PixelCluster to Pointfield text swap of `diagram-3_interaction-modes_spec_v1.md` (kept). Spec substance unchanged; only product-name strings updated.
