...
Run: python3 diagram-3_build.py  ->  diagram-3_interaction-modes_v1.svg"""
import math, random
...
<!-- PixelCluster - Diagram 3: interaction modes (v1, 2026-05-29). Generated, seed 42.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1600 900" width="1600" height="900" font-family="'Helvetica Neue', Helvetica, Arial, sans-serif">
  ...
  <text x="64" y="66" fill="#6b665e" font-size="14" letter-spacing="3" font-family="ui-monospace,'SF Mono',Menlo,monospace">PIXELCLUSTER — INTERACTION</text>
...
with open("/Users/ciamac/Developer/splat-desktop/launch/diagram-3_interaction-modes_v1.svg", "w") as f:
    f.write(svg)
print("wrote diagram-3_interaction-modes_v1.svg")
