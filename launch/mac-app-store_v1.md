# PixelCluster — Mac App Store Submission (v1)
...
- Create a new macOS app. Display name: **PixelCluster**.
...
- App Store Connect metadata:
  ...
  - **Privacy nutrition label: "Data Not Collected."** PixelCluster collects nothing; processing is fully local.
  - Age rating: 4+.
- Submit for review.
